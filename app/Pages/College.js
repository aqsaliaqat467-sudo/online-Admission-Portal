    ...
    return (
        <View style={{ backgroundColor: "#ffff", height: "100%" }}>
            ...
            <View style={{ flex: 1, justifyContent: "center"}}>
                <Carousel
                    ...
                    renderItem={({ item }) => (
                        <Image
                            source={item}
                            style={{ width: "90%", height: 180, alignSelf: "center", borderRadius: 20, marginTop: 12 }}
                            resizeMode="cover"
                        />
                    )}
                />
            ...
            <TouchableOpacity onPress={() => navigation.navigate("Courses")}
                style={{ backgroundColor: "#0b3c66", borderRadius: 10,  height: 40, width: "70%", alignSelf: "center" }}>
            ...
            <View style={{ width: '20%', height: 70, backgroundColor: "#D9D9D9", borderRadius: 100, alignItems: "center", marginTop: 15, marginBottom: 15, alignSelf: "flex-end", marginRight: 15 }}>
