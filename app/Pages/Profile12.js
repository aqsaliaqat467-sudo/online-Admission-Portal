...
const Profile = ({ navigation }) => {
    ...
    return (
        <ScrollView style={{ backgroundColor: "#ffffffff", height: '100%' }}>
            ...
            <View style={{ width: "29%", height: 100, borderRadius: 50, backgroundColor: '#dae0e5ff', alignSelf: 'center', justifyContent: 'center', alignItems: 'center' }}>
            ...
            <View style={{ width: '90%', alignSelf: 'center', height: 50, flexDirection: 'row', marginTop: '5%' }}>
                <TextInput placeholder=' First Name' onChangeText={(e) => setfirstname(e)} style={{ borderBottomWidth: 1, borderColor: '#ccc', width: '45%' }} />
                <TextInput placeholder=' Last Name' onChangeText={(e) => setlastname(e)} style={{ borderBottomWidth: 1, borderColor: '#ccc', width: '45%', marginStart: '5%' }} />
            </View>
            <View style={{ width: '90%', alignSelf: 'center', height: 50, flexDirection: 'row', marginTop: '9%' }}>
