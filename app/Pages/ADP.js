    ...
    return (
        <View style={{ backgroundColor: "#ffff", height: "100%" }}>
            ...
            <View style={{ backgroundColor: "#0b3c66", borderRadius: 10, marginTop: 25, height: 40, width: "70%", alignSelf: "center" }}>
                <Text style={{ color: "#fff", fontWeight: "700", marginTop: 9, textAlign: "center", fontSize: 18 }}>ADP</Text>
            </View>
            <TouchableOpacity onPress={() => navigation.navigate("ADS")}
            style={{ width: '55%', height: 40, backgroundColor: "#D9D9D9", borderRadius: 10, marginTop: 15, marginStart: 80 }}>
                <Text style={{ fontSize: 18, color: "#000000ff", textAlign: "center", marginTop: 5 }}>ADS (Science)</Text>
            </TouchableOpacity>
            <TouchableOpacity onPress={() => navigation.navigate("ADA")}
            style={{ width: '55%', height: 40, backgroundColor: "#D9D9D9", borderRadius: 10, marginTop: 15, marginStart: 80 }}>
                <Text style={{ fontSize: 18, color: "#000000ff", textAlign: "center", marginTop: 5 }}>ADA (Art's)</Text>
            </TouchableOpacity>
        </View>
    )
}
