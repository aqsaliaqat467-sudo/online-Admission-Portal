    ...
    return (
        <View style={{ backgroundColor: "#ffff", height: "100%" }}>
            ...
            <View style={{ backgroundColor: "#0b3c66", borderRadius: 10, marginTop: 20, height: 40, width: "70%", alignSelf: "center" }}>
                <Text style={{ color: "#fff", fontWeight: "700", marginTop: 8, textAlign: "center", fontSize: 18 }}>ADA (Art's)</Text>
            </View>
            <View style={{ height: '60%', width: '100%', backgroundColor: "#ebe2e2ff", marginTop: 12, borderRadius: 10 }}>
